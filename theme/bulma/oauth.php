    ...
    <div class="bd-main-container container">
        <div class="bd-duo">
            <div class="bd-lead">
                ...
                ?>
                <h1 class="title is-4"><?php echo $lang['almostthere']; ?>
                    <h1>
                            ...
                            <div class="columns">
                                <div class="column">
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <input readonly="" type="text" class="input" name="autoname"
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <input type="text" class="input" name="new_username"
                                                   placeholder="<?php echo $lang['setuser']; ?>">
                                        </div>
                                    </div>
                                    <div class="field is-grouped">
                                        <div class="control">
                                            <input class="button is-info" type="submit" name="user_change"
                                                   value="Submit" value="<?php echo md5($date . $ip); ?>">
                                        </div>
                                        <div class="control">
