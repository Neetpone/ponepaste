 ...
 <article class="message is-danger" id="panel" style="display: none;" >               	
  ...
  <div class="message-body">
    <div class="columns">
     ...
     <div class="column">
        <form class="form-horizontal" id="reportpaste" name="preport" action="report.php" method="POST">
                <div class="select" >
               ...
               <div class="column">
                ...
                <input class="button is-danger is-fullwidth"  type="submit" name="reportpaste" id="report" value="Report Paste" />
                </div>
                </div>
        </form>
					...
					<div class="columns is-multiline">
                        <div class="column is-4">
                            ...
                            <span class="tag is-normal"><i class="fa fa-star fa-lg" aria-hidden="true"></i>&nbsp;&nbsp;<?php echo $fav_count; ?></span>
                            <br>
                            <span class="tag is-normal"><i class="fa fa-file-word fa-lg" aria-hidden="true"></i>&nbsp;&nbsp; <?php $wordcount = str_word_count($op_content) ; echo $wordcount ?></span>
                            <span class="tag is-normal"><i class="fa fa-hdd fa-lg" aria-hidden="true"></i>&nbsp;&nbsp;<?php $pastesize = strlen($op_content) ; echo formatBytes($pastesize) ?></span>
                         ...
                         <div class="column is-4 has-text-right">
							<div class="">
								<div class="panel-tools">
                                    ...
                                    ?>
                                    <a class="icon tool-icon" class="flip" onclick="openreport()"><i class="far fa-flag fa-lg has-text-grey" title="Report Paste"></i></a>
									...
									<?php } ?>
									<a class="icon tool-icon" href="#" onclick="selectText('paste');"><i class="far fa-clipboard fa-lg has-text-grey" title="Select Text"></i></a>
						...
						<?php } else { ?>
							...
							<h1 class="title is-6 mx-1"><?php echo $lang['modpaste']; ?><h1>
									<form class="form-horizontal" name="mainForm" action="index.php" method="POST">
										...
										<!-- Text area -->
										<textarea style="line-height: 1.2;" class="textarea mx-1" rows="13" id="code" name="paste_data" onkeyup="countChars(this);" onkeydown="return catchTab(this,event)" placeholder="helloworld"><?php echo htmlentities($op_content, ENT_QUOTES, 'UTF-8'); ?></textarea>
        ...
        <div class='row is-full'>                       
            <div class="columns">
                <div class="column">                       
                    ...
                    <div class="control">
                      <input  id="tags-with-source" name="tags" class="input" data-max-tags="10" data-max-chars="40" type="text" data-item-text="name" data-case-sensitive="false" placeholder="10 Tags Maximum" value="<?php echo $p_tagsys;?>">
                    </div>
                        </div>
                            </div>
                                </div>
