...
class Parsedown {
    ...
    protected $safeLinksWhitelist = array(
        ...
        'https://s1.desu-usergeneratedcontent.xyz/mlp/',
        'https://s2.desu-usergeneratedcontent.xyz/mlp/',
        'https://giphy.com',
        'http://bronibooru.com',
        'https://poneb.in',
        ...
        'http://www.dragon-mango.com',
        'http://mittsies.com',
        'https://pokehidden.archive.hexstream.net',
        'http://arcade.equestriagaming.net',
        'http://swfchan.net',
        'https://modworkshop.net',
        'https://minelittlepony-mod.com',
        'https://github.com',
        'https://lords-of-ponykeep.tumblr.com',
        'https://twitter.com',
        'https://sneakykitty.net',
        'https://aftercase.itch.io',
        'https://gitlab.com',
        'http://www.equestriagaming.net',
        'https://oddwarg.itch.io',
        'http://oddwarg.com',
        'https://rpgmaker.net',
        'https://empalu.itch.io',
        'https://fallout-equestria-remains.fandom.com',
        'https://www.equestriandreamers.com',
        'https://www.equestriadaily.com/',
        'https://soft-lava.itch.io',
        ...
        'https://www.moddb.com',
        'https://equestria-at-war.fandom.com',
        'https://theponies.org',
        'http://equidev.net',
        'http://foe.ucoz.org',
    ...
    protected function inlinewebm($Excerpt) {
